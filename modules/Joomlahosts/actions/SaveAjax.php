...
class Joomlahosts_SaveAjax_Action extends Vtiger_SaveAjax_Action {

	public function process(Vtiger_Request $request) {
		global $log;
		$log->debug('ENTERING --> Joomlahosts_SaveAjax_Action::process()');
		...
		$jsql = array();
		$jsql['joomlahost_dbtype']	= $recordModel->get('joomlahost_dbtype');
		$jsql['j_host'] 			= $recordModel->get('j_host');
		$jsql['j_dbname'] 			= $recordModel->get('j_dbname');
		$jsql['j_dbuser'] 			= $recordModel->get('j_dbuser');
		$jsql['j_dbpassword'] 		= $recordModel->get('j_dbpassword');
		$jsql['j_dbprefix'] 		= $recordModel->get('j_dbprefix');
		$jsql['host_no'] 			= $recordModel->get('host_no');
		$recordId = $recordModel->getId();
		
		$log->debug("RUN --> Joomlahosts_SaveAjax_Action::process() Record_id: $recordId, JSQL: ". print_r($jsql, true) );
		
		$checked = Joomlahosts_Record_Model::SetSQLCheck($jsql, $recordId);
